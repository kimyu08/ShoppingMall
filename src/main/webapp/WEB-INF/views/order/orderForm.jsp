...
<div class="cart" align="center">
	...
	<table>
		...
		<c:forEach var="cartdto" items="${cartdto}">
			...
			<input type="hidden" name="opcode" value="${cartdto.opcode}">
	...
	<br><br>
		...
		<h3 >배송지 정보</h3>
		배송지 선택 <input type="radio" name="chk_info" value="nor" checked onclick="setForm(this.value);">기본배송지 
		<input type="radio"	name="chk_info" value="new" onclick="setForm(this.value);">신규배송지
		<div id="divNor">
			<table class="table">
				<tr> 
					<th>주문자</th>
				...
				<tr>
					...
					<td style="text-align: left"><input type="text" name="zipcode"
						...
						<input type="button" id="zipbtn" value="주소찾기" onclick="DaumPostcode()" style="display:none">
					</td>
				</tr>
				<tr>
					<th>주소</th>
...
<script>
	function setForm(value) {
		if (value == "nor") {
			$('#mname').val('${memdto.mname}');
			$('#phone').val('${memdto.phone}');
			$('#zipcode').val('${memdto.zipcode}');
			$('#address1').val('${memdto.address1}');
			$('#address2').val('${memdto.address2}');
